...
const ReceiptScreen: React.FC<any> = ({ route, navigation }) => {
    ...
    const { address, weight, distance, wasteCategory, time } = route.params;
    ...
    return (
        <SafeAreaView style={tw`flex-1 mt-10 flex-col justify-between`}>
            ...
            <View style={{ padding: 20, justifyContent: "center", alignItems: "center" }}>
                <TouchableOpacity onPress={() => navigation.navigate("Menu")} style={{ padding: 10, backgroundColor: color.primaryColor, width: "90%", borderRadius: 10 }}>
